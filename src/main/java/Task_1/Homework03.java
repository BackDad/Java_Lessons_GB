...
public class Homework03 {
    public static void main(String[] args) {
        ...
        Teacher teacher01 = new Teacher("Василий", "Пупкин");
        Teacher teacher02 = new Teacher("Петро", "Гвоздев");
        ...
        StudentGroup StudentGroup03 = new StudentGroup("Group03", 2, teacher01);
        StudentGroup StudentGroup04 = new StudentGroup("Group04", 3, teacher01);
        StudentGroup StudentGroup05 = new StudentGroup("Group05", 4, teacher02);
        StudentGroup StudentGroup06 = new StudentGroup("Group06", 5, teacher01);
        StudentGroup StudentGroup07 = new StudentGroup("Group07", 6, teacher02);

        List<Human> students = new ArrayList<Human>();
        students.add(new Student("Майкл", "Батов", 3));
        students.add(new Student("Антон", "Камолов", 5));
